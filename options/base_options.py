...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--N_p', type=int, default=5, help='the sum of the poses')
        self.parser.add_argument('--N_d', type=int, default=90, help='the sum of the identities')
